...
<title>Barak NCO Registration</title>
<!-- for-mobile-apps -->
...
<script>
    ...
    .then((value) => {
                window.location.href = "http://cse.stereoserver.com/SAD/reg_nco.php";
});
</script>'; 
...
<form action="http://cse.stereoserver.com/SAD/action_reg_nco.php" method="post">
  <div class="container">
    <h1>Barak NCO Register</h1>
...
-->
  ...
  <!-- <input list="rank" placeholder="Select Rank from the dropdown" name="rank"> -->
   <div class="custom-select">
   <select id="rank" name="rank" required>
        <option value="Not Selected">Select Rank: </option>
        <option value="Sainik">Sainik(Snk)</option>
  ...
  <!--<datalist id="rank">
    <option value="Sainik(Snk)">
    <option value="Lance Corporal(L Cpl)">
    <option value="Corporal(Cpl)">
    <option value="Sergeant(Sgt)">
  </datalist>--><br><br>
  
  <label for="sol_no"><b>Soldier No</b></label>
    <input type="text" placeholder="Enter your Soldier No" name="sol_no" required>
    
    <label for="address"><b>Address</b></label>
    <input type="text" placeholder="Enter your present Address" name="address" required>
    
    <label for="unit"><b>Cantonment Name</b></label>
   <!-- <input type="text" placeholder="Enter your Cantonment Name" name="unit" required> -->
   <div class="custom-select">
    <select id="unit" name="unit" required>
        <option value="Dhaka Cantonment">Select Cantonment: </option>
    ...
    <input id="contact" type="tel" placeholder="Enter Contact no" name="contact" required>
...
function myFunction() {
    ...
    if((n1||n2||n3||n4) && (nn1||nn2)) window.location.href = "http://cse.stereoserver.com/SAD/action_reg_nco.php";
